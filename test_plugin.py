...
class TestPlugin:
    ...
    def __init__(self, iface):
        ...
        self.dlg = TestPluginDialog(self.iface)
    ...
    def run(self):
        ...
        try:
            ...
            self.dlg.active_layer_input.setText(active_layer_name)
        except AttributeError:
            message = "there is no active layer"
            self.iface.messageBar().pushInfo("Notice", message)
    ...
    def listen(self):
        ...
        # show the dialog
        self.dlg.show()
        self.iface.currentLayerChanged.connect(self.dlg.update_layer_name)
